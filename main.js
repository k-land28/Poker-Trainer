...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function showMainMenu() {
    ...
    mainContent.innerHTML = `
      ...
      <br><a href="mailto:50_soother.fault@icloud.com?subject=PokerTrainerアプリのFB&body=フィードバックのご協力ありがとうございます。以下にご意見をご記入ください。
      %0A%0A---%0Aアプリのバージョン ：0.1.0%0A使用環境（例: iPhone 14, Safari）： %0A開発者からの連絡 ：可 / 不可%0AFBの内容（欲しい機能や使い勝手の悪かった点など）: "
      style="  display: inline-block;padding: 12px 24px; margin: 10px; color: #0ff; background-color: transparent; 
      border: 2px solid #0ff; border-radius: 8px; font-size: 18px; font-weight: bold; letter-spacing: 1px; cursor: pointer;
      transition: 0.3s ease; box-shadow: 0 0 5px #0ff, 0 0 10px #0ff, 0 0 20px #0ff;">✉️フィードバック</a>
      <p>ver. 0.1.0</p>
    `;
