...
export const translations = {
  ja: {
    ...
    "powerno_chart_note": () => 
    "M値 = <span class='fraction'><span class='numerator'>(SB + BB + Ante)</span><span class='denominator'>スタック</span></span><br>必要パワー = M値 × 後ろの人数<br>ハンドのパワーが必要パワーを超えていれば Push が正当化されます。"  },
  ...
  en: {
    ...
    "powerno_chart_note": () => 
    "M = <span class='fraction'><span class='numerator'>(SB + BB + Ante)</span><span class='denominator'>Stack</span></span><br>Required Power = M × Number of players behind<br>If your hand's power exceeds the required power, pushing is justified."  } 
}