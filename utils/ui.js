...
export function setBodyClass(mainMode) {
  document.body.classList.remove('mainMenu-body', 'preflop-body', 'range-body', 'powerNo-body', 'quiz-body', 'timer-body', 'howto-body', 'setting-body');
  ...
  } else if (mainMode === 'powerNo') {
    document.body.classList.add('powerNo-body');
